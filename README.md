...
# FlutterBleLibFork
This is Flutter BLE LIB Fork which is Migrated to Dart 3..
This is Lib is Upgrade to Dart 3 from this [flutter_ble_lib](https://pub.dev/packages/flutter_ble_lib/versions)
Credits: [flutter_ble_lib](https://pub.dev/packages/flutter_ble_lib/versions)
